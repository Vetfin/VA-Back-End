class Zillow
  ...
  def initialize
    ...
    Building.all.each do |building|
      begin
        make_condos(get_zpids(building), building)
  ...
  def make_condos(zpids, building_obj)
    zpids.each do |zpid|
      ...
      if status == "For Sale"
        ...
        Condo.create(street_address: address, city: "Washington", state: "DC", price: price, sq_ft: sq_ft, beds: beds, baths: baths, zillow_id: zpid.to_i, building_id: building_obj.id)
      end
    end
  end
